...
class CPMTrainer(Trainer):
    def __init__(self, model, args, map_fn, train_dataset, eval_dataset, tokenizer, model_init, compute_metrics, callbacks, optimizers, preprocess_logits_for_metrics, reducer=None):
