...
class LongformerSelfAttention(nn.Cell):
    ...
    def construct(
        ...
        *attention_window* happens in [`LongformerModel.forward`] to avoid redoing the padding on each layer.
        ...
        attn_probs = ops.softmax(
            attn_scores, axis=-1, dtype=ms.float32
    ...
    def _chunk(hidden_states, window_overlap, onnx_export: bool = False):
        ...
        if not onnx_export:
            ...
            hidden_states = hidden_states.view(
                ...
                ops.div(hidden_states.shape[1], (window_overlap * 2), rounding_mode="trunc"),
                window_overlap * 2,
    ...
    def _sliding_chunks_matmul_attn_probs_value(
        self, attn_probs: ms.Tensor, value: ms.Tensor, window_overlap: int
    ):
        """
        ...
        chunked_attn_probs = attn_probs.swapaxes(1, 2).reshape(
            ...
            ops.div(seq_len, window_overlap, rounding_mode="trunc"),
            window_overlap,
            2 * window_overlap + 1,
        )
    ...
    def _compute_global_attn_output_from_hidden(
        ...
        global_attn_probs_float = ops.softmax(
            global_attn_scores, axis=-1, dtype=ms.float32
        )  # use fp32 for numerical stability
