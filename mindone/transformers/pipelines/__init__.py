...
SUPPORTED_TASKS = {
    ...
    "summarization": {
        ...
        "default": {
            "model": {"ms": ("sshleifer/distilbart-cnn-12-6", "a4f8f3e"), "tf": ("google-t5/t5-small", "df1b051")}
        },
        "type": "text",
    },
    ...
    "translation": {
        ...
        "ms": (AutoModelForSeq2SeqLM,) if is_mindspore_available() else (),
        "default": {
            ("en", "fr"): {"model": {"ms": ("google-t5/t5-base", "a9723ea"), "tf": ("google-t5/t5-base", "a9723ea")}},
            ("en", "de"): {"model": {"ms": ("google-t5/t5-base", "a9723ea"), "tf": ("google-t5/t5-base", "a9723ea")}},
            ("en", "ro"): {"model": {"ms": ("google-t5/t5-base", "a9723ea"), "tf": ("google-t5/t5-base", "a9723ea")}},
        },
        "type": "text",
    },
    "text2text-generation": {
        ...
        "ms": (AutoModelForSeq2SeqLM,) if is_mindspore_available() else (),
        "default": {"model": {"ms": ("google-t5/t5-base", "a9723ea"), "tf": ("google-t5/t5-base", "a9723ea")}},
        "type": "text",
    },
    "text-generation": {
